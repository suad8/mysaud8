    ...
    <header className="sticky top-0 z-40 border-b bg-[var(--surface-raised)]/85 backdrop-blur-md">
      ...
      <div className="bg-brand-800 text-center text-[13px] text-brand-50">
        <p className="mx-auto max-w-7xl px-4 py-2">
          شحن مجاني للطلبات فوق <span className="num font-semibold">300</span> ر.س · إرجاع خلال{" "}
          <span className="num font-semibold">14</span> يوماً
        </p>
      </div>
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4">
        <Link href="/" className="flex shrink-0 items-center gap-2.5">
          ...
          <span className="hidden text-lg font-bold tracking-tight sm:block">نسيم</span>
        </Link>
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <Link href="/cart" aria-label="السلة" className="relative grid h-10 w-10 place-items-center rounded-xl transition-colors hover:bg-ink-100 dark:hover:bg-ink-800">
            ...
            <span className="num absolute -top-0.5 end-0.5 grid h-5 min-w-5 place-items-center rounded-full bg-gold-500 px-1 text-[11px] font-bold text-ink-950">
              2
            </span>
          </Link>
        </div>
