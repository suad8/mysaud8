...
export function LoginForm({ storeInfo }: { storeInfo: StoreInfoSettings }) {
    ...
    <div className="flex min-h-dvh items-center justify-center bg-[var(--surface)] px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-2.5">
          <StoreLogo name={storeInfo.name} logoUrl={storeInfo.logoUrl} size={56} />
          <div className="text-center">
            <p className="text-lg font-bold">{storeInfo.name}</p>
